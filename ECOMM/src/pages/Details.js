...
import { fetchProductDetail, fetchReview,sendReview } from "../components/Fetcher";
...
const Details = () => {
    ...
    useEffect(() => {
    fetchProductDetail(setProduct,slug);
    fetchReview(setReview,slug);
    }, [])
                      ...
                      {review.map((rev)=>{
                        return (
                          <div class="reviews-submitted">
                            <div class="reviewer">
                              {rev.name} - <span>01 Jan 2020</span>
                            </div>
                            <div class="ratting">
                              {[...Array(rev.star)].map(()=>{
